...
## サイト概要
### サイトテーマ
絵本を読んで育児の悩みを解決　お悩み別に適した絵本を検索できるレビューサイト
<!-- 【補足説明】 -->
<!-- - 〜なコミュニティサイトorレビューサイトorSNS　と１文で記載する --> 
​
### テーマを選んだ理由
4歳息子と1歳娘の子育てをする2児のパパです。子供が元気に育ってくれるのは嬉しいものですが、成長に伴い子育て悩みも増えてきました。
言葉で説明してもなかなか難しいことも多く、日頃読み聞かせている絵本を使って子供に伝えられないかと考えました。
<!-- 【補足説明】 -->
